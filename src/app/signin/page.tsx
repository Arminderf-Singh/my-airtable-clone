...
export default function SignIn() {
  ...
  useEffect(() => {
    ...
    // We'll let the server-side redirect handle this
  }, [router]);
      ...
      <div className="body-content">
        <div className="signin-container">
          <div className="signin-card">
            <h1 className="signin-title">Log in to Airtable Clone</h1>
            <p className="signin-subtitle">Welcome back! Log in to your account.</p>
